 ...
 * originally src/performance_page/widgets/graph_widget.rs. The GRAPH_RADIUS
 * constant, upstream `crate::performance_page::widgets::GRAPH_RADIUS`, is
 * defined locally here since this project has no performance_page module.
 *
...
// Upstream sources this from `crate::performance_page::widgets::GRAPH_RADIUS`
// (performance_page/widgets/mod.rs); Phase 1 has no performance_page module,
// so the same value lives here.
